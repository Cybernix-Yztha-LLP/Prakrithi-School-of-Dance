  ...
  return (
    <section id="contact-home" className="py-12 md:py-16 bg-gray-100">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <Button asChild className="[font-family:'Labrada',Helvetica] font-medium bg-[#2c282a] text-white text-base sm:text-lg md:text-xl lg:text-2xl px-6 py-2.5 sm:px-8 sm:py-3 rounded-full hover:bg-[#1a1818] transition-colors">
